CLASS zcl_fabap_jul2025_exer05_fvf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_FABAP_JUL2025_EXER05_FVF IMPLEMENTATION.
...
METHOD get_data BY DATABASE PROCEDURE
   ...
   et_data = select Connection.carrierid as CarrierId,
                    ...
                    case when AirportFromId = 'SFO' then '080000'
                        else Connection.departuretime end as DepartureTime,
